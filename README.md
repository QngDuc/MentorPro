...
- **Google Generative AI (Gemini)**: tài liệu và SDK chính thức (hướng dẫn sử dụng model, methods, và authorization).
  - Docs: https://developers.generativeai.google
  - Python SDK (pypi): https://pypi.org/project/google-generativeai/

- **Hugging Face Spaces**: xem phần Logs / Runtime khi deploy app trên Spaces.
  - Docs: https://huggingface.co/docs/hub/spaces

- **Supabase**: dùng cho backend database (nếu cấu hình). Tham khảo cách tạo client và API.
  - Docs: https://supabase.com/docs

- **FastAPI**: framework backend, interactive docs built-in (/docs, /redoc).
  - Docs: https://fastapi.tiangolo.com

- **TextBlob**: thư viện simple NLP dùng cho phân tích sentiment trong project.
  - Docs: https://textblob.readthedocs.io

- **python-dotenv**: tải biến môi trường từ file `.env` (không commit file `.env` lên VCS).
